...
public class PersonajeTest {
	...
	void inicializarEstadisticasTest() {
		...
		Raza skarn = new Raza(0, "Skarn", "", 100, 100, 100, 100, 100, 100, TipoHabilidad.MAGICO_FUEGO, TipoHabilidad.FISICO_CONTUNDENTE);
		...
		if(
				personaje.getSalud() == skarn.getSaludBase() && personaje.getStamana() == skarn.getStamanaBase()
		...
		if(
				personaje.getSalud() == skarn.getSaludBase() + item.getSaludExtra() && personaje.getStamana() == skarn.getStamanaBase() + item.getStamanaExtra()
				&& personaje.getAgilidad() == skarn.getAgilidadBase() + item.getAgilidadExtra() && personaje.getSuerte() == skarn.getSuerteBase() + item.getSuerteExtra()
				&& personaje.getDefensa() == skarn.getDefensaBase() + item.getDefensaExtra() && personaje.getAtaque() == skarn.getAtaqueBase() + item.getAtaqueExtra()
