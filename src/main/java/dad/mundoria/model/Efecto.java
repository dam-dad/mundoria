...
public class Efecto {
	...
	public void aplicarEfecto(Entidad objetivo, int modificadorPuntos) { // TODO Actualmente esto cambia las
																			// estadísticas de manera permanente, hay
																			// que cambiarlo.

		switch (tipo) {
		// Curación se calcula en base al valor propio de la habilidad más el
		// modificador de puntos entre tirada de dados y Ataque del atacante
		case CURACION:
			objetivo.modificarEstadistica("salud", valor + modificadorPuntos);
			break;
		// Daño se calcula en base al valor propio de la habilidad más el modificador de
		// puntos entre tirada de dados y Ataque del atacante menos la defensa del
		// objetivo
		case DAÑO:
